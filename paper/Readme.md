...
```
data <- list_score(region_names = "all", city_names = "all", university_names = "all", department_names = "all", var_ids = c("X11", "X12", "X13"),  lang = "en")
...
ggplot(map1) +
        ...
        coord_map() +
        theme_void() +
        scale_fill_distiller(name = " Number of Placed Students", palette = "Reds", direction = 1,
...
```
data2 <- list_score(region_names = "all", city_names = "all", university_names = "all",
                               department_names = "all", var_ids = c("X11", "X12", "X13"), lang = "en")
