...
#' }
#' @source \url{https://yokatlas.yok.gov.tr/}
#' @usage data(regions_cities)
"regions_cities"
...
#'Information in English about departments, faculties in Turkish universities.
#'
#' A dataset containing type, faculty, deparment information and other statistcs in English for 198 universties in Turkey .
#'
#' @format A data frame with 25652 rows and 198 variables:
#' \describe{
#'   \item{id}{University id}
